...
#define ALL_MODSECURITY_FILTER_STATS(COUNTER, GAUGE, HISTOGRAM)         \
  ...
  COUNTER(crs_inbound_anomaly_score_threshold_exceeded)                 \
  COUNTER(crs_outbound_anomaly_score_threshold_exceeded)                \
  COUNTER(detection_only_crs_inbound_anomaly_score_threshold_exceeded)  \
  COUNTER(detection_only_crs_outbound_anomaly_score_threshold_exceeded) \
